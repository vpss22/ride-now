...
class Fare {
  ...
  Fare.fromJson(Map<String, dynamic> json) {
    ...
    waitingFeePerMin = double.tryParse(json['waiting_fee_per_min'].toString());
    minCancellationFee = double.tryParse(json['min_cancellation_fee'].toString());
    idleFeePerMin = double.tryParse(json['idle_fee_per_min'].toString());
    tripDelayFeePerMin = double.tryParse(json['trip_delay_fee_per_min'].toString());
    penaltyFeeForCancel = double.tryParse(json['penalty_fee_for_cancel'].toString());
    feeAddToNext = double.tryParse(json['fee_add_to_next'].toString());
