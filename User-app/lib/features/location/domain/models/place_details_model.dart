...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    utcOffsetMinutes = int.tryParse(json['utcOffsetMinutes'].toString());
    ...
    pureServiceAreaBusiness = json['pureServiceAreaBusiness'] != null ? (bool.tryParse(json['pureServiceAreaBusiness'].toString()) ?? (json['pureServiceAreaBusiness'].toString() == '1')) : null;
...
class Photos {
  ...
  Photos.fromJson(Map<String, dynamic> json) {
    name = json['name'];
    widthPx = int.tryParse(json['widthPx'].toString());
    heightPx = int.tryParse(json['heightPx'].toString());
