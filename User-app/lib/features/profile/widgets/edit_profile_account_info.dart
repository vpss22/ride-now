      ...
      return Column(children: [
        Expanded(child: SingleChildScrollView( controller: _scrollController,
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            TextFieldTitle(title: 'first_name'.tr, textOpacity: 0.8, isRequired: true),
            ...
            if(profileController.additionalFields.isNotEmpty)...[
              Text('provide_additional_info'.tr, style: textSemiBold),
        ...
        ButtonWidget (
          ...
          onPressed: () async {
            if(idNumberController.text.isNotEmpty && (idNumberController.text.length < 6 || idNumberController.text.length> 50)){
              ...
              Response response = await profileController.updateProfile(SignUpBody(
                fName: firstNameController.text,
                lName: lastNameController.text,
                identificationType: profileController.identityType,
                identificationNumber: idNumberController.text,
