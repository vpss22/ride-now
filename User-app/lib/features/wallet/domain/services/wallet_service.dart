...
class WalletService implements WalletServiceInterface{
  ...
  @override
  Future getTransactionList({required int offset, required String transactionType, required String durationType, required String sDate, required String eDate}) async{
    return await walletRepositoryInterface.getTransactionList(offset: offset, transactionType: transactionType, durationType: durationType, sDate: sDate, eDate: eDate);
  }
