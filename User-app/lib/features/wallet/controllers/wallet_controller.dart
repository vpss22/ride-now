...
class WalletController extends GetxController implements GetxService{
  ...
  final List<String> durationFilterList = ['all_time', 'this_week', 'this_month', 'this_year', 'custom_date'];
  final List<String> transactionTypeList = ['both', 'debit', 'credit'];
  ...
  void resetFilters({bool isUpdate = true}) {
  ...
  Future<Response> getTransactionList(int offset) async {
    isLoading = true;
    update();
    Response? response = await walletService.getTransactionList(
      offset: offset,
      transactionType: transactionTypeList[selectedTransactionTypeIndex],
      durationType: durationFilterList[selectedDurationIndex],
      sDate: durationFilterList[selectedDurationIndex] == 'custom_date' ? (customDateStart ?? '') : '',
      eDate: durationFilterList[selectedDurationIndex] == 'custom_date' ? (customDateEnd ?? '') : '',
    );
