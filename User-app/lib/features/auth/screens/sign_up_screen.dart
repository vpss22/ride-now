...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(child: Scaffold(
      backgroundColor: Theme.of(context).canvasColor.withValues(alpha:150),
              ...
              Container(
                ...
                child: Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeLarge),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("basic_info".tr, style: textBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
      ...
      bottomNavigationBar: Container(
        decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.only(topRight: Radius.circular(Dimensions.radiusExtraLarge), topLeft: Radius.circular(Dimensions.radiusExtraLarge))
        ),
