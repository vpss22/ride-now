...
class Discount {
  ...
  Discount.fromJson(Map<String, dynamic> json) {
    ...
    image = json['image'];
    discountAmount = json['discount_amount'] != null ? int.tryParse(json['discount_amount'].toString()) : null;
    ...
    maxDiscountAmount = json['max_discount_amount'] != null ? int.tryParse(json['max_discount_amount'].toString()) : null;
    minTripAmount = json['min_trip_amount'] != null ? int.tryParse(json['min_trip_amount'].toString()) : null;
    limit = json['limit'] != null ? int.tryParse(json['limit'].toString()) : null;
    startDate = json['start_date'];
    endDate = json['end_date'];
