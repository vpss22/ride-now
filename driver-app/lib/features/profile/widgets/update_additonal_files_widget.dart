  ...
  Future<void> _pickFile(BuildContext context) async {
    ...
    try {
      ...
      if (pickedFile != null) {
        ...
        onFilesSelected(updated.map((e) => e is String ? e : (e is XFile ? e : XFile(e.toString()))).toList());
      }
    } catch (e) {
      assert(() {
          ...
          if (selectedFiles.isNotEmpty) ...[
            ...
            ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                final String path = file is String ? file : (file as XFile).path;
                ...
                return isImage
                  ...
                  onRemove: () {
                    final updated = List<dynamic>.from(selectedFiles)..removeAt(index);
                    onFilesSelected(updated.map((e) => e is String ? e : (e is XFile ? e : XFile(e.toString()))).toList());
                  },
                )
                    : _FileRow(
      ...
      child: Stack(
        children: [
          ClipRRect(
            ...
            ImageWidget(
              image: '${Get.find<SplashController>().config?.imageBaseUrl?.additionalData}/$file',
              width: previewWidth,
...
class _FileRow extends StatelessWidget {
  ...
  String get _fileName => file is String ? file.split('/').last : (file as XFile).path.split('/').last;
